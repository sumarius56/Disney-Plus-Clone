...
function FirebaseAdapter(client) {
  ...
  const Users = collection(db, exports.collections.Users).withConverter(
    exports.format
  );
  const Sessions = collection(db, exports.collections.Sessions).withConverter(
    exports.format
  );
  const Accounts = collection(db, exports.collections.Accounts).withConverter(
    exports.format
  );
  const VerificationTokens = collection(
    db,
    exports.collections.VerificationTokens
  ).withConverter(exports.format);
  return {
